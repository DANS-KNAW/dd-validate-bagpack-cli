...
2. Extract it to some location on your system, for example `/opt/dans.knaw.nl/dd-validate-bagpack-cli`.
3. Start the service with the following command
   ```
   /opt/dans.knaw.nl/dd-validate-bagpack-cli/bin/dd-validate-bagpack-cli server /opt/dans.knaw.nl/dd-validate-bagpack-cli/cfg/config.yml 
   ```
